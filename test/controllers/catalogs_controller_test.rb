...
class CatalogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create catalog" do
    assert_difference("Catalog.count") do
      post catalogs_url, params: { catalog: { company_id: @catalog.company_id, group_id: @catalog.group_id, name: @catalog.name } }
    end
  ...
  test "should update catalog" do
    patch catalog_url(@catalog), params: { catalog: { company_id: @catalog.company_id, group_id: @catalog.group_id, name: @catalog.name } }
