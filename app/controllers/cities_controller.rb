class CitiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @city.save
        format.html { redirect_to city_url(@city), notice: 'Ciudad creada correctamente.'}
  ...
  def update
    respond_to do |format|
      if @city.update(city_params)
        format.html { redirect_to city_url(@city), notice: 'Ciudad actualizada correctamente.'}
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to cities_url, notice: 'Ciudad eliminada correctamente.'}
