...
# Es para el tema de las fechas, calculos para fechas y graficos
gem "groupdate"

# Para el tema de permisos [https://github.com/CanCanCommunity/cancancan]
gem 'cancancan'

# Para los qr
gem 'prawn-qrcode'

# Para lso graficos y dashboards
gem 'apexcharts'
